...
function managementPage({ accounts, selected, csrf, message, managementAccountIds, destinations }) {
  ...
  <script>(()=>{let theme=null;try{theme=localStorage.getItem('comeover-admin-theme')??localStorage.getItem('account-management-theme')}catch{}theme=theme==='light'||theme==='dark'?theme:(matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light');document.documentElement.dataset.theme=theme;document.documentElement.style.colorScheme=theme})()</script><style>
