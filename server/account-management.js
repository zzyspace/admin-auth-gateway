...
function managementPage({ accounts, selected, csrf, message, managementAccountIds, destinations }) {
  ...
  const centerIcons = {
    store: '<svg viewBox="0 0 32 32" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 13v15h22V13M3 13l3-9h20l3 9M3 13c0 5 6.5 5 6.5 0 0 5 6.5 5 6.5 0 0 5 6.5 5 6.5 0 0 5 6.5 5 6.5 0M12 28v-8h8v8"/></svg>',
